...
class Tasks extends Component {
    ...
    render() {
        ...
        return (
            // <div>
            //     {Object.keys(TasksObj).map(el => {
            //         return <h1 style={{ color: "black" }}>{TasksObj[el].title}</h1>
            //     })}
            // </div>
            ...
            <Card className="card">
                <CardHeader
                    avatar={
                        <Avatar aria-label="Recipe" className="avatar" style={{ background: 'yellow' }} />
                    }
                    // title={task.title}
                    title="Procedura di immatricolazione"
